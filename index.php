...
<?php
 ...
 include 'header.php'; ?>
<?php if(isset($_SESSION['login_username']) and $_SESSION['login_user_type']==1) include 'admin_navbar.php'; else include 'navbar.php'; ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary submit" onclick="$('#uni_modal form').submit()">
              <?php echo (isset($_SESSION['login_username']) and $_SESSION['login_user_type']==1) ? 'Save' : 'Find' ?> 
          </button>
